...
export function SettingsPanel({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      <button type="button" className="absolute inset-0 bg-black/50 backdrop-blur-sm" onClick={onClose} aria-label={t('common.close')} />
      <div className="relative w-full max-w-md bg-[#0c0c0e] border-l border-slate-800 h-full flex flex-col shadow-2xl">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="space-y-2">
            <label htmlFor="settings-provider" className="text-sm font-medium text-slate-300">
              {t('settings.provider')}
            </label>
            <input
          ...
          <div className="space-y-2">
            <label htmlFor="settings-model" className="text-sm font-medium text-slate-300">
              {t('settings.model')}
            </label>
            <input
              id="settings-model"
