...
def test_persisted_plan_hash_is_self_contained_and_not_reinterpreted_by_catalog() -> None:
    plan = materialize_hook_plan(RuntimeHooksConfig(enabled=True), agent_hook_refs=("role_reminder",))
