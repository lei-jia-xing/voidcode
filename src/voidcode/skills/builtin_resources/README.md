...
- `build-verification.md` is a VoidCode-local build system verification guide. It ensures that agents verify generated CMake/Make/Meson projects with a configure/build check before reporting completion.
