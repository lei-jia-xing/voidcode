...
| **Kimi** (Moonshot AI) | `kimi` | `https://api.moonshot.ai/v1` | `KIMI_API_KEY` |
| **OpenCode Go** | `opencode-go` | `https://opencode.ai/zen/go/v1` | `OPENCODE_GO_API_KEY` |
| **Qwen** (通义千问) | `qwen` | `https://dashscope.aliyuncs.com/compatible-mode/v1` | `DASHSCOPE_API_KEY` |

#### 模型发现策略

| Provider | Discovery 方式 | 说明 |
| :--- | :--- | :--- |
| **GLM** | `/v1/models` endpoint | OpenAI-compatible，自动发现 |
| **MiniMax** | `/v1/models` endpoint | OpenAI-compatible，自动发现 |
...
| **Kimi** | `kimi-k2.5`, `kimi-k2`, `kimi-k2-turbo`, `kimi-k2-thinking` |
| **OpenCode Go** | `kimi-k2.5`, `minimax-m2.7`, `minimax-m2.5`, `glm-5`, `glm-5.1`, `mimo-v2-pro`, `mimo-v2-omni`, `qwen3.5-plus`, `qwen3.6-plus` |
